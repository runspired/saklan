...
[![lerna version](https://img.shields.io/github/package-json/dependency-version/runspired/saklan/dev/lerna)](https://lerna.js.org/)
[![pnpm version](https://img.shields.io/github/package-json/packageManager/runspired/saklan)](https://pnpm.io/)
[![Generate Release Candidate](https://github.com/runspired/saklan/actions/workflows/release.yml/badge.svg?event=workflow_dispatch)](https://github.com/runspired/saklan/actions/workflows/release.yml)
...
```sh
git clone git@github.com:runspired/saklan.git
```
